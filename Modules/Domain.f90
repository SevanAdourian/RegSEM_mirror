module sdomains
  ...
  type :: domain
     ...
     type(mirror) :: mirror_displ, mirror_force, mirror_excit
     type(src_ext) :: ssrc_ext

     logical :: curve, aniso, ocean, ellipticity, comp_rot, adjoint, save_trace, save_snapshot, MPML
     ...
     integer :: n_source, n_dim, n_glob_nodes, n_mat, n_nodes, n_receivers, n_proc, &
          ...
          ngll_grid_x, ngll_grid_y, ngll_grid_z, recl_init

     integer, dimension(:), pointer :: indx_gll,indy_gll,indz_gll
     ! <SA> Indeces of position in the global MIRROR file
     integer, dimension(:), pointer :: index_pos

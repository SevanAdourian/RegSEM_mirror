...
! In define_arrays.f90, lines 280 to 299 have to be commented, and lines 135 to 143 have to be uncommented.
...
stop 'PLEASE USE get_region_param INSTEAD OF get_value_aniso !!!'
...
if (gll==0) then
   region = 0
   if (bary(1)>20.d0 .and. bary(1)<56.d0 .and. bary(2)>20.d0 .and. bary(2)<56.d0 .and. bary(3)>20.d0 .and. bary(3)<56.d0) then

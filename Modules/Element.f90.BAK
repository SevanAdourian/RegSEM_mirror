...
integer :: mat_index, cov_index, moho_position, topo_position, mirror_position, mirror_position_ext, ngllx,nglly,ngllz, indx,indy,indz
...
real, dimension (:,:,:), pointer :: win_mirror, win_mirror_ext

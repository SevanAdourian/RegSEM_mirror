subroutine internal_forces (Elem, i_simu, hprimex, htprimex, hprimey, htprimey, hprimez, htprimez, n_solid, aniso, adj, trm, apply_external_event)
...
logical, intent(IN) :: aniso, adj, apply_external_event
...
if (aniso) then
   if (n_solid>0) then
      ...
      if(.not.apply_external_event)then
...
subroutine calcul_forces_aniso_att(Fox,Foy,Foz, xi1,xi2,xi3,et1,et2,et3,ga1,ga2,ga3, &
                             ...
                             mu_,la_, Cij, ngllx,nglly,ngllz, n_solid, onemSbeta_, R_xx_,R_yy_,R_xy_,R_xz_,R_yz_,apply_external_event)

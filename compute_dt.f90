subroutine Compute_dt (Tdomain,dt,fmax)
...
doubleprecision, intent (INOUT) :: dt, fmax

integer :: i,j,k, n, ngllx,nglly,ngllz, idef0,idef1, u,v,w
doubleprecision :: dx,dxmin, dxmax, vp, lam,mu,rho, ratio,ratio_max, freq
    ...
    do k = 0,ngllz-2
       do j = 0,nglly-2
          do i = 0,ngllx-2
              ...
              ! we need 5 grid point per wavelength)

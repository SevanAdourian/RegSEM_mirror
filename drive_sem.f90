...
if(rg==0)then
 write(*,*)'indx_gll :',rg
 do i  = 0,Tdomain%n_elem_x-1
    write(*,*)i,Tdomain%indx_gll(i)
 enddo
 write(*,*)
 write(*,*)'indy_gll :',rg
 do i  = 0,Tdomain%n_elem_y-1
    write(*,*)i,Tdomain%indy_gll(i)
 enddo
 write(*,*)
 write(*,*)'indz_gll :',rg
 do i  = 0,Tdomain%n_elem_z-1
    write(*,*)i,Tdomain%indz_gll(i)
 enddo
endif
...
call mirror_definition (Tdomain,rg)
